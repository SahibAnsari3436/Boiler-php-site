...
/* Show hide content on the sell your boiler page*/

function toggleMore(el) {
      const moreContent = el.previousElementSibling;
...
const track = document.getElementById('johnston-carousel-track');
...
// Pause/resume on manual nav
document.getElementById('johnston-carousel-next').addEventListener('click', () => {
  moveToNextSlide();
  resetAutoplay();
});

document.getElementById('johnston-carousel-prev').addEventListener('click', () => {
  moveToPrevSlide();
  resetAutoplay();
});
...
const fileInput = document.getElementById("fileInput");
    ...
    fileInput.addEventListener("change", () => {
      ...
      if (files.length === 0) {
        ...
        fileName.textContent = "You can upload up to 5 files only.";
