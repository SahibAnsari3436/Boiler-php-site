    ...
    <section class="content-inner-2">
        <div class="container">
             <div class="action-links style-1 text-center m-b30 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                <a href="printitems.php?type=other" class="action-link"><i class="fas fa-print"></i> Printable Page</a>
                <a href="download_pdf.php?type=other" class="action-link"><i class="fas fa-file-pdf"></i> Download PDF</a>
...
// Get total records
$totalResult = mysqli_query($con, "SELECT COUNT(*) as total FROM other_table");
...
$result = mysqli_query($con, "SELECT * FROM other_table ORDER BY created_at ASC LIMIT $startFrom, $perPage");
?>
    ...
    <tbody>
      <?php if ($result && mysqli_num_rows($result) > 0): ?>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td><input type="checkbox" class="itemCheckbox" data-table="other_table"
