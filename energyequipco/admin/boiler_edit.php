...
$page_title = isset($page_titles[$current_file]) ? $page_titles[$current_file] : 'Add New Boiler';
...
if ($id) {
    $res = mysqli_query($con, "SELECT * FROM our_boilers WHERE id=$id");
...
<form method="post" action="boiler.php" enctype="multipart/form-data">
        ...
        <a href="boiler.php" class="btn btn-secondary">Back</a>
    </form>
</div>
