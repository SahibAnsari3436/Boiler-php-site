...
$page_title = isset($page_titles[$current_file]) ? $page_titles[$current_file] : 'Pivacy Policy';
...
<a href="privacy_policy_edit.php" class="btn btn-primary">Edit Policy</a>
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="privacy_policy_edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning my-1">
